package com.abmcloud.cf.test.AppFormTests.Body;
...
public class FieldsValidation extends BaseTest {
    ...
    public void autoInsertChain() {
        steps
                ...
                .assertTrue(compare("23.11.2017", appFormSteps.getCatalogValue(appFormDB.dateField4)));
    }
    ...
    public void choseFutureDate() {
        steps
                ...
                .selectAppByNumber(numberOfCreatedApp)
                .clickOnNumberOf(selectedApp)
                .asserts().assertTrue(compare(getTomorrowDate(), dateField.getValue(appFormDB.dateField2)));
    }
    ...
    public void choseYesterdayDate() {
        steps
                ...
                .selectAppByNumber(numberOfCreatedApp)
                .clickOnNumberOf(selectedApp)
                .asserts().assertTrue(compare(getYesterdayDate(), dateField.getValue(appFormDB.dateField2)));
    }
